...
<body>
	<div id="pageBody">
		...
		<div id="userBar">
			...
			<br />
			<span style="border-left: 0px; font-weight: bold; font-size: x-large;">
			<% 
				try {
					GlobalProperty gp = Context.getAdministrationService().getGlobalPropertyObject("mohtracportal.defaultLocationId");
					int currentLocId = (gp != null & gp.getPropertyValue().trim().compareTo("") != 0) ? Integer.valueOf(gp.getPropertyValue()): 1;
					Location loc = Context.getLocationService().getLocation(currentLocId);
