...
<!-- this page should be overriding the default patientDashboardForm of openmrs, this means, this page will replace the existing one, 
to do this, check on http://wiki.openmrs.org how to override the openmrs-runtime.propertie file, and check exactly the line 
showing how to specify 'custom.patientDashboardForm.jsp.file'

custom.patientDashboardForm.jsp.file=myfolder/mypatientDashboardForm.jsp
...
<openmrs:globalProperty var="enableRegimensTab" key="Regimens.enableDashboardTab" defaultValue="true"/>
<openmrs:globalProperty var="enableGraphsTab" key="Graphs.enableDashboardTab" defaultValue="true"/>
